                ...
                f = {
                    ...
                    _show: function (e) {
                        ...
                        o.stop(true, true).fadeIn(n.duration, function () {
                            n.onShow != null && typeof n.onShow == "function"
                                ? n.onShow(o, s)
                                : null;
                        });
                    },
                    _hide: function (e) {
                        ...
                        o.stop(true, true).fadeOut(n.duration, function () {
                            n.onHide != null && typeof n.onHide == "function"
                                ? n.onHide(o, s)
                                : null;
                            f._clear();
                            $(this).remove();
                    ...
                    _fixTitle: function (a) {
                        if (a) {
                            if (
                                f.hasAttr("data-title") &&
                                !f.hasAttr("title") &&
                                f._lsWtI[0] == true
                            ) {
                                s.attr("title", f._lsWtI[1] || "").removeAttr(
                                    "data-title"
                                );
                            }
                        } else {
                    ...
                    _position: function (a) {
                        var css = { top: 0, left: 0 },
                            position = a
                                ? a
                                : f.hasAttr(n.attr + "-position")
                                ? s.attr(n.attr + "-position")
                                : n.position,
                            arrow = position.split("-"),
                            offset = f.hasAttr(n.attr + "-offset")
                                ? s.attr(n.attr + "-offset")
                                : n.offset,
                            style = {
                        ...
                        if (
                            $.inArray(position, p) == -1 ||
                            $.inArray(position, f._lsWpI) !== -1
                        ) {
                            f._hide();
                            return css;
                        } else {
                        ...
                        switch (arrow[0]) {
                            case "bottom":
                                css.top =
                                    style.offsetTop + style.height + offset;
                                if (
                                    css.top >=
                                    wStyle.height + wStyle.scrollTop
                                ) {
                            ...
                            case "top":
                                css.top =
                                    style.offsetTop - tStyle.height - offset;
                            ...
                            case "left":
                                css.top =
                                    ...
                                    tStyle.height / 2;
                                css.left =
                                    style.offsetLeft - tStyle.width - offset;
                                if (css.left <= 0) {
                            ...
                            case "right":
                                css.top =
                                    ...
                                    tStyle.height / 2;
                                css.left =
                                    style.offsetLeft + style.width + offset;
                    ...
                    _createBox: function () {
                        ...
                        o.css(f._position());
                        if (
                            (n.cls != null && typeof n.cls == "string") ||
                            f.hasAttr(n.attr + "-cls")
                        ) {
                            o.addClass(
                                f.hasAttr(n.attr + "-cls")
                                    ? s.attr(n.attr + "-cls")
